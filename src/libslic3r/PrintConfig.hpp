...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloatsOrPercents,   toolhead_line_width))
    ((ConfigOptionFloatsOrPercents,   toolhead_initial_layer_line_width))
    ((ConfigOptionFloatsOrPercents,   toolhead_outer_wall_line_width))
    ((ConfigOptionFloatsOrPercents,   toolhead_inner_wall_line_width))
    ((ConfigOptionFloatsOrPercents,   toolhead_top_surface_line_width))
    ((ConfigOptionFloatsOrPercents,   toolhead_sparse_infill_line_width))
    ((ConfigOptionFloatsOrPercents,   toolhead_internal_solid_infill_line_width))
    ((ConfigOptionFloatsOrPercents,   toolhead_support_line_width))
    ((ConfigOptionFloatsOrPercents,   toolhead_bridge_line_width))
